export const Footer = () => {
  return (
    <div className="bg-gradient-to-r from-green-100 to-green-200 py-2 w-full">
      <div className="flex gap-5 justify-center ">
        <a
          href="https://github.com/imranN74/joblytics"
          title="joblytics's github"
      ...
      <div className="flex justify-center mt-2">
        <div>
          Made by <strong>Imran</strong> with
        </div>
        <svg
          className="w-6 h-6 text-gray-800 dark:text-white"
          aria-hidden="true"
